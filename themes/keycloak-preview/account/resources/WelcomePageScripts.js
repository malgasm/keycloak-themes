...
var toggleLocaleDropdown = function () {
  var localeDropdownList = document.getElementById(
    "landing-locale-dropdown-list",
  );
  if (localeDropdownList.hasAttribute("hidden")) {
    localeDropdownList.removeAttribute("hidden");
    document
      .getElementById("landing-locale-dropdown-button")
...
var toggleMobileChooseLocale = function () {
  var mobileLocaleSelectedIcon = document.getElementById(
    "mobileLocaleSelectedIcon",
  );
  var isDropdownClosed =
    mobileLocaleSelectedIcon.classList.contains("fa-angle-right");
  ...
  for (var i = 0; i < availableLocales.length; i++) {
    ...
    var mobileLocaleSelection = document.getElementById(
      "mobile-locale-" + availableLocales[i].locale,
    );
    if (isDropdownClosed) {
